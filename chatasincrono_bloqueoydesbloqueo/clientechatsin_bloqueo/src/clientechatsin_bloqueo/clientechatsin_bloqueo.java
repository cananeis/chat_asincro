...
//MATRICULA: 16440448
package clientechatsin_bloqueo;
 ...
 * @author FERNANDO
 */
public class clientechatsin_bloqueo {
    ...
    public clientechatsin_bloqueo(String serverAddress) {
    ...
    public static void main(String[] args) throws Exception {
        ...
        if (v_ip == true) {
            clientechatsin_bloqueo client = new clientechatsin_bloqueo(args[0]);
